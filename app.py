...
SUPPORT_DESK_NUMBER = os.environ.get('SUPPORT_DESK_NUMBER', '+34932201555')
WORKSPACE_SID = os.environ.get('WORKSPACE_SID', 'WS3559014d96000918bc2091712bd02c85')
WORKFLOW_SID = os.environ.get('WORKFLOW_SID', 'WWe3b15175ad1fc864b17fb97797b3905c')
